#+TITLE:    Python - Install Anaconda3 and Jupyter Lab
#+INCLUDE: "common.inc"
...
[no] >>> yes
no change     /home/seba/anaconda3/condabin/conda
no change     /home/seba/anaconda3/bin/conda
no change     /home/seba/anaconda3/bin/conda-env
no change     /home/seba/anaconda3/bin/activate
no change     /home/seba/anaconda3/bin/deactivate
no change     /home/seba/anaconda3/etc/profile.d/conda.sh
no change     /home/seba/anaconda3/etc/fish/conf.d/conda.fish
no change     /home/seba/anaconda3/shell/condabin/Conda.psm1
no change     /home/seba/anaconda3/shell/condabin/conda-hook.ps1
no change     /home/seba/anaconda3/lib/python3.7/site-packages/xontrib/conda.xsh
no change     /home/seba/anaconda3/etc/profile.d/conda.csh
modified      /home/seba/.bashrc
...
#+BEGIN_EXAMPLE
pip --version
pip 20.0.2 from /home/seba/anaconda3/lib/python3.7/site-packages/pip (python 3.7)
#+END_EXAMPLE
...
(base) seba@vnu20:~$ conda install -c conda-forge ipympl
...
## Package Plan ##
  ...
  environment location: /home/seba/anaconda3
...
Executing transaction: done
(base) seba@vnu20:~$ ls
anaconda3      Desktop    Music     rclone_backup.sh  Videos
anaconda3.txt  Documents  Pictures  snap              worklog.txt
c_workspace    Downloads  Public    Templates
...
(base) seba@vnu20:~$ conda install nodejs
Collecting package metadata (current_repodata.json): done
Solving environment: done
...
(base) seba@vnu20:~$ which jupyter
/home/seba/anaconda3/bin/jupyter
...
(base) seba@vnu20:~$ jupyter labextension install @jupyter-widgets/jupyterlab-manager
Building jupyterlab assets (build:prod:minimize)

(base) seba@vnu20:~$ jupyter labextension install jupyter-matplotlib
Building jupyterlab assets (build:prod:minimize)
...
* Running Jupyter Lab on remote server
...
See http://jupyter-notebook.readthedocs.io/en/latest/public_server.html for the full details of running the Jupyter server remotely.

* Jupyter Kernels

Jupyter supports many programming languages by installing their "kernels."
...
** Jupyter - config Nginx Reverse Proxy

https://jupyterhub.readthedocs.io/en/latest/reference/config-proxy.html


https://jupyterhub.readthedocs.io/en/latest/reference/config-examples.html?highlight=nginx#using-a-reverse-proxy
